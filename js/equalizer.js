...
class Equalizer extends AppModule {
	/**
	...
	constructor(obj) {
		let options = {
			childElements: '[data-js-atom="equalizer-child"]',
	...
	render() {
		...
		setTimeout(() => {
			App.Vent.trigger(App.EVENTS.equalizer.render, {
				el: this.$el,
...
Equalizer.classMixin(ImageLoader);
